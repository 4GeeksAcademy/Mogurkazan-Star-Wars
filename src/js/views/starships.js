...
export const VistaSS = (props) => {
	...
	useEffect(()=>{
		console.log('se cargo la pag')
				fetch('https://www.swapi.tech/api/starships/' + params.starships_id)
	...
	return (
		<div className="vista1 container">
			<div className="row">
				...
				<img className="img-fluid" src={`https://raw.githubusercontent.com/4GeeksAcademy/Mogurkazan-Star-Wars/master/src/img/starships/s${params.starships_id}.jpg`} alt="..." />
				</div>
