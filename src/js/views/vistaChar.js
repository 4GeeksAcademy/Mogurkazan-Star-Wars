	...
	return (
		<div className="vista1 container">
			<div className="row">
				...
				<img className="img-fluid" src={`https://raw.githubusercontent.com/4GeeksAcademy/Mogurkazan-Star-Wars/master/src/img/characters/c${params.vistaChar_id}.jpg`} alt="..." />
				</div>
